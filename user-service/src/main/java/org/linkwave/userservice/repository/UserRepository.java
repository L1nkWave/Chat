...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    long getUsersCountByUsernameStartsWith(String requestUsername, String username);
    ...
    List<UserEntity> getUsersByUsernameStartsWith(String requestUsername, String username, int offset, int limit);
